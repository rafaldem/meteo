...
def test_get_temperature_daily(client, user_headers):
   ...
   response = client.get('/api/temperature/test-sensor-1?timeframe=daily',
                         headers=user_headers)
...
def test_get_temperature_weekly(client, user_headers):
   ...
   response = client.get('/api/temperature/test-sensor-1?timeframe=weekly',
                         headers=user_headers)
...
def test_get_temperature_monthly(client, user_headers):
   ...
   response = client.get('/api/temperature/test-sensor-1?timeframe=monthly',
                         headers=user_headers)
...
def test_get_temperature_yearly(client, user_headers):
   ...
   response = client.get('/api/temperature/test-sensor-1?timeframe=yearly',
                         headers=user_headers)
